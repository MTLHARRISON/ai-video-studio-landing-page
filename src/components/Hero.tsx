...
export function Hero() {
  return <div className="relative h-screen w-full overflow-hidden bg-black">
      {/* F1 Background Video */}
      <video className="absolute inset-0 w-full h-full object-cover scale-110" autoPlay muted loop playsInline>
      ...
      delay: 0.3
        ...
        <div className="w-full px-6 sm:px-8 lg:px-12 py-4 bg-black/50 backdrop-blur-xl border-b border-white/10">
          <div className="flex items-center justify-between">
            ...
            scale: 1.05
          }} className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo({
            top: 0,
            behavior: 'smooth'
          })}>
